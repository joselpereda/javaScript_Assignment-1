...
// Exercise 2:Provide example of numeric literal expression, a string literal expression, a Boolean literal expression, and a null literal expression
// 4.5                                             //numeric literal expression
// "Hola! How are you?"                            //string literal expression
// true                                            //Boolean literal expression
// null                                            //null literal expression

// Exercise 3: Give two examples of complex/variable expressions
...
// Exercise 4: Declare (but do not assign) 9 variables for the following identifiers: First Name, Last Name, Address, City, State, Zip Code, 
...
// Exercise 5: Take the 3 of the 9 variables that you created above and demonstrate 3 ways for declaring and assigning values to those variables.
...
// Exercise 8: Is the following string literal valid? If not, how would you fix it?
...
// Exercise 9: Create a variable that produces a null value in the console window. 
...
// Exercise 10: Use the unary typeof operator on various literals to return the following types within the console window: string, number, Boolean, object, and undefined
...
// Exercise 11: Within an alert box, use the concatenation operator (+) to display text in the alert box that appears as follows: 
...
// Exercise 12: Declare a variable called name and set it equal to your name. 
...
// Exercise 13: Declare a variable called course and set it equal to “JavaScript”. 
...
// Exercise 17: Declare a variable called x and assign it a value of 10. 
...
// Exercise 18: Declare a variable called x and assign it a value of 20. 
...
// Exercise 19: Declare a variable called x and assign it a value of 20.
...
// Exercise 20: Declare a variable called x and assign it a value that equals the remainder of 20 divided by 3.
